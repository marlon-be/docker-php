...
# PHP + extensions
RUN apt-get -y -f --force-yes install php7.0-cli php7.0-dev php7.0-mysql php7.0-xmlrpc php7.0-curl curl libicu-dev php7.0-sqlite php-memcached php-pear php7.0-xsl php7.0-mcrypt php7.0-gd php7.0-intl php7.0-mbstring php7.0-bcmath
