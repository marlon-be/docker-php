...
# PHP + extensions
RUN apt-get -y -f --force-yes install php5.6-cli php5.6-dev php5.6-mysql php5.6-xmlrpc php5.6-curl curl libicu-dev php5.6-sqlite php5.6-memcache php-pear php5.6-xsl php5.6-mcrypt php5.6-gd php5.6-intl
